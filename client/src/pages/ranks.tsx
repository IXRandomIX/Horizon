...
export default function RanksPage() {
  ...
  // Only show quests that are active in the current cycle
      ...
      <div className="max-w-4xl mx-auto px-6 py-10 space-y-10">
                ...
                <div key={type} className="space-y-2">
                  ...
                  {quests.map(quest => {
                    ...
                    return (
                      <div
                        key={quest.id}
                        className="rounded-xl border px-4 py-3 flex items-center gap-4 border-white/10 bg-white/[0.02]"
                      >
                        ...
                        <div className="flex-shrink-0 text-right">
                          <span
                            ...
                            style={{
                              background: completed ? "rgba(255,255,255,0.05)" : `${QUEST_TYPE_COLORS[type]}22`,
                              color: completed ? "rgba(255,255,255,0.2)" : QUEST_TYPE_COLORS[type]
                            }}
                          >
                            +{quest.xp} XP
                          </span>
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-2xl border border-white/10 overflow-hidden divide-y divide-white/5">
            {[...RANKS].reverse().filter(r => r.rank !== 0).map((r) => {
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{
                      background: achieved || isCurrentRank ? `${r.color}22` : "rgba(255,255,255,0.05)",
                      border: `1.5px solid ${achieved || isCurrentRank ? r.color : "rgba(255,255,255,0.08)"}`
                    }}
                  >
