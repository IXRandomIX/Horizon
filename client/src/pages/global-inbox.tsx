...
import { Inbox, PenLine, X, Send, Loader2, Crown } from "lucide-react";
            ...
            <div className="space-y-4">
              {messages.map((msg, i) => (
                <motion.div
                  ...
                  className="bg-white/[0.03] border border-white/10 rounded-2xl p-5 hover:border-white/15 transition-colors"
                >
                  {/* Author bar */}
                  ...
                  {/* Content */}
                  <p className="text-white/85 leading-relaxed whitespace-pre-wrap text-sm">{msg.content}</p>
                </motion.div>
              ))}
              <div ref={bottomRef} />
            </div>
